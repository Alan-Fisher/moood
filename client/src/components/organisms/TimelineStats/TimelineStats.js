...
import { TimelineStatsStyle } from './TimelineStatsStyle'
import { MoodModel } from '../../../models'
import { Badge, Spinner, Text } from '../../atoms'

const TimelineStats = () => { // TODO: refactor this gathered on the knee component
...
TimelineStats.propTypes = {
  history: PropTypes.shape({
    push: PropTypes.func.isRequired,
  }).isRequired,
}

export default withRouter(observer(TimelineStats))
